...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        List<int[][]> downfire = new ArrayList<>();
        downfire.add(ShapeMatrix.FIRE_DOWN_1);
        downfire.add(ShapeMatrix.FIRE_DOWN_2);
        downfire.add(ShapeMatrix.FIRE_DOWN_3);

        downFire = new RocketFire(downfire);

        List<int[][]> lr_fire = new ArrayList<>();
        lr_fire.add(ShapeMatrix.FIRE_SIDE_1);
        lr_fire.add(ShapeMatrix.FIRE_SIDE_2);
        rightFire = new RocketFire(lr_fire);
        leftFire = new RocketFire(lr_fire);
    }
